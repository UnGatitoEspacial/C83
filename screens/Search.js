...
//2 importar la base de datos config
...
export default class SearchScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      //mostrar como vaciar allTransactions
      allTransactions: [],
      searchText: ""
    };
  }
...
//3 fuinsion que muestra datos de transacciones
  getTransactions = () => {
...
//4 flat list enumera todas las transaccioon en data, renderItem
  renderItem = ({ item, i }) => {
    var date = item.date
      .toDate()
      .toString()
...
//5 funcion que ara la consulta de busqueda de los datos
